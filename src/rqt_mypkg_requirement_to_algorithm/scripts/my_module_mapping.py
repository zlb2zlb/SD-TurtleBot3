...
class MyPlugin_mapping(Plugin):
    ...
    def map_1_selected(self):
         if self._map_flag:
            ...
            self.map = "1"
            # 设置环境变量
            os.environ['MAP_FILE'] ='turtlebot3_world.yaml'
            os.environ['WORLD_DIR'] ='turtlebot3_world.world'
    ...
    def map_2_selected(self):
         if self._map_flag:
            ...
            self._map = "2"
            # 设置环境变量
            os.environ['MAP_FILE'] ='world_cylinder_4_0.yaml'
            os.environ['WORLD_DIR'] ='world_cylinder_4_0.world'
            self._map_flag = False
